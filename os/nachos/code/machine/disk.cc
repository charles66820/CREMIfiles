...
static void PrintSector(bool writing, int sector, const void *data) {
...
void Disk::ReadRequest(int sectorNumber, void *data) {
  ...
  if (DebugIsEnabled('d')) PrintSector(FALSE, sectorNumber, data);
...
void Disk::WriteRequest(int sectorNumber, const void *data) {
  ...
  if (DebugIsEnabled('d')) PrintSector(TRUE, sectorNumber, data);
