...
int OpenFile::Read(void *into, int numBytes) {
  int result = ReadAt(into, numBytes, seekPosition);
  seekPosition += result;
  return result;
}

int OpenFile::Write(const void *into, int numBytes) {
...
int OpenFile::ReadAt(void *into, int numBytes, int position) {
...
int OpenFile::WriteAt(const void *from, int numBytes, int position) {
  int fileLength = hdr->FileLength();
  int i, firstSector, lastSector, numSectors;
